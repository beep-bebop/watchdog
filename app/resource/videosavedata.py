...
class VideoSaveData(Resource):
    ...
    def post(self):
        ...
        print((request.get_json())['recorddate'])
        print((request.get_json())['recordminute'])
        ...
        if((request.get_json())['recorddate'] and (request.get_json())['recordminute']):
            ...
            print("start:" + str(startyear) + str(startday) + " end:" + str(endyear) + str(endday))
